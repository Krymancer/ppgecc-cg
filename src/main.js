...
// Otimizações no Renderizador
const pixelRatio = window.devicePixelRatio || 1;
renderer.setPixelRatio(pixelRatio);
const newWidth = window.innerWidth ; // Tamanho reduzido pela metade
const newHeight = window.innerHeight ; // Tamanho reduzido pela metade
